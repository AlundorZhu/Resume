...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Designed a real-time clinical assessment algorithm achieving over 99\% agreement with physician scoring on the Box-and-Blocks task; optimized CoreML enabled real-time inference on a 60fps stream on iPhone. (\href{https://github.com/AlundorZhu/CMORE-app}{IOS demo app} on github)
                \item Collected and curated 190k+ labeled images and developed a semi-automatic labeler (SAM2 + OpenCV + Tkinter) that largely reduced manual labeling time.
