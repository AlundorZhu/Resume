    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed a real-time clinical assessment algorithm achieving over 99\% agreement with physician scoring on the Box-and-Blocks task; optimized for CoreML to enable real-time inference on a 240fps stream without frame drops on iPhone.
